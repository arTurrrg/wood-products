export default function LeftAboutCard() {
  return (
    <div className="flex-1">
      <div className="pl-44 text-neutral-100 leading-normal">
        ...
        <div className="pt-20 pl-2 text-2xl">
          ...
          <p>chairs, armchairs, wardrobes, beds</p>
          <p>and much more in our own</p>
          <p>workshop, equipped with all the</p>
          <p>necessary industrial equipment.</p>
        </div>
      </div>
    </div>
  );
